  ...
  <div class="p-2 w-full">
    <div class="font-extrabold flex items-center justify-between mt-0.5 mb-1.5">
      <div class="flex items-center">
        ...
        <span class="hidden md:inline-block font-[300] text-[15px] text-gray-500 pl-2">{{
          tweet.handle
        }}</span>
      </div>
      <div
      ...
      >
        ...
        >
          <Link
            as="button"
            method="delete"
            :href="route('tweets#destory', { id: tweet.id })"
    ...
    <div v-if="tweet.file">
      ...
      <div v-else>
        <video class="rounded-xl" :src="tweet.file" controls />
      </div>
    </div>
