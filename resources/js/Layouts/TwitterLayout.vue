<template>
    ...
    <div class="max-w-[1400px] flex mx-auto">
      ...
      <div class="lg:w-3/12 w-[60px] h-[100vh] max-w-[350px] lg:px-4 lg:mx-auto">
        ...
        <button
          ...
          class="lg:w-full mt-8 ml-2 text-white font-extrabold text-[22px] bg-[#1C9CEF] p-3 rounded-full cursor-pointer"
        >
      ...
      <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-800 pl-4">
        ...
        >
          ...
          <input
            class="apperance-none w-full border-0 py-2 bg-[#212327] text-gray-100 placeholder-gray-500 leading-tight focus:ring-0"
        ...
        <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
          ...
          >
            <div class="flex p-3 justify-between h-[80px] py-3">
              ...
              <img :src="ranImg2" class="rounded-xl" />
            </div>
          </div>
          <div
          ...
          >
            <div class="flex p-3 justify-between">
              <div class="">
                ...
                <div class="text-[14px] text-gray-400">48,345 Tweets</div>
              </div>
              <DotsHorizontal fillColor="#5e5c5c" />
            </div>
          </div>
  ...
  <div
    v-if="createTweet"
    class="fixed top-0 md:mx-auto w-full min-h-screen bg-black md:bg-gray-400 md:bg-opacity-30 md:p-3"
    id="overlay-section"
  >
    <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
      ...
      <div class="w-full flex">
        <div class="ml-3.5 mr-2">
          <img :src="ranImg1" alt="" width="55" class="rounded-full" />
        </div>
...
//random image
let ranImg1 = ref(`https://picsum.photos/id/${(Math.random() * 200).toFixed(0)}/100`);
let ranImg2 = ref(`https://picsum.photos/id/${(Math.random() * 200).toFixed(0)}/100`);

let createTweet = ref(false);
let textaera = ref(null);
let tweet = ref("");
let file = ref("");
let showUpload = ref("");
let uploadType = ref("");
...
const textareaInput = (e) => {
  textaera.value.style.height = "auto";
  textaera.value.style.height = `${e.target.scrollHeight}px`;
};
